...
public class PainelCadastro extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PainelCadastro frame = new PainelCadastro();
	...
	public PainelCadastro() {
		...
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(PainelCadastro.class.getResource("/img/home.png")));
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(550, 150, 711, 629);
