...
public class ReProDialogSobre extends JDialog implements MouseListener {
	...
	public static void main(String[] args) {
		try {
			ReProDialogSobre dialog = new ReProDialogSobre();
	...
	public ReProDialogSobre() {
		...
		btnGitHub.setName("GitHub");
                btnGitHub.setIcon(new ImageIcon(getClass().getResource("/img/github.png")));
		...
		btnLinkedin.setIcon(new ImageIcon(getClass().getResource("/img/linkedin2.png")));
		...
		btnWhatsApp.setIcon(new ImageIcon(getClass().getResource("/img/Whatsapp.png")));
